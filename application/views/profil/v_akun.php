   ...
   <?php echo form_open_multipart('profil/akunupdate'); ?>
     <div class="form-group">
      ...
      <input type="file" name="file" accept="image/*" class="form-control" />
       ...
       <input id="signupName" name="name" placeholder="Nama" value="<?php echo ($datacontent)?$datacontent->user_nama:'' ?>" type="text" maxlength="50" class="form-control"/>
     </div>
    <div class="form-group">
       <label class="control-label" for="signupTelp">Nomor Telepon : </label>
       <input id="signupTelp" name="telp" placeholder="Telepon" value="<?php echo ($datacontent)?$datacontent->user_telpon:'' ?>" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="15" class="form-control"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <textarea name="alamat" id="alamat" style="width:100%; height:70px;"><?php echo ($datacontent)?$datacontent->user_alamat:'';?></textarea>
    </div>
     <div class="form-group">
