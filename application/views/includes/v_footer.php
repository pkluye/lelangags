        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="col-md-12 table-responsive">
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" class="text-right">Harga Tawaran</th>
                    </tr>
                  </thead>
                  <tbody id="ltawaran">
                  </tbody>
                ...
                <!--        <label for="text">Anggaran :</label>-->
                <!--        <input name="anggaran" placeholder="1,000,000" type="text" id="anggaran" oninput="setFormat(this.id)"  class="form-control" required autofocus/>   -->
                        <input type="hidden" name="lid">
                <!--   </div>-->
                   <!--<div class="form-group col-md-12">-->
                   <!--  <label for="text">Tanggal Selasai :</label>-->
                   <!--  <input type="date" id="tglselesai" name="tglselesai"  class="form-control" min="<?=date("m/d/Y")?>" required />-->
                   <!--</div>-->
                <!--</div>-->
          </div>
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Jml</th>
                      <th scope="col" class="text-right">HPS</th>
