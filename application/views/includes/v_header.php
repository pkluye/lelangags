<head>
  ...
  <script src="<?=base_url()?>assets/web/js/bootstrap-datetimepicker.js"></script>
  ...
  <div class="main_menu">
    ...
    <div class="containers">
      ...
      <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
        <ul class="nav navbar-nav mr-auto">
          <li class="nav-item"><a class="nav-link" href="<?=base_url()?>">Home</a></li>
             <li class="nav-item submenu dropdown">
                 <a href="" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Lelang</a>
              <ul class="dropdown-menu">
                <li class="nav-item"><a class="nav-link" href="<?=base_url()?>lelang/pasang">Pasang Lelang</a></li>
                <li class="nav-item"><a class="nav-link" href="<?=base_url()?>lelang/tampil">Lihat Lelang</a></li>
              </ul>
              </li>
          ...
          <!--<button class="btn btn-success" type="button">Search</button>-->
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" id="word" name="word" placeholder="Cari. . ." class="form-control" required/>
                    <!--<span class="input-group">-->
                    <div class="input-group-append">
                        <button class="btn" style="background-color:transparent; color:white;" id="srcBtn" type="submit" value="Cari"><i class="fas fa-search"></i></span></button>
                    </div>
                    <!--</span>-->
                </div>                        
            </div>
        ...
        <?php if(isset($_SESSION['data_user'])){ ?>
            <div class="dropdown" style="">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:white; list-style:none;">
                    ...
                    &nbsp; <b><?=$_SESSION['data_user']['user_nama']?></b></a>
        ...
        <?php } else { ?>
            <div class="dropdown" style="">
                <a class="user-link" href="<?=base_url()?>login"><i class="fas fa-door-open"></i>&nbsp; Masuk</a>
                <a class="user-link">&ensp; | &ensp;</a>
                <a class="user-link" href="<?=base_url()?>register"><i class="fas fa-id-card-alt"></i>&nbsp; Daftar</a>
            </div>
        <?php } ?>
      </div>
    </div>
