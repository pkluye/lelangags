        ...
        <div class="panel-body col-md-12">
          <?php echo form_open('login/check'); ?>
           ...
           <div class="form-group">
             ...
             <input id="loginPassword" name="pass" placeholder="Password" value="<?php echo set_value('pass'); ?>" type="password" maxlength="25" class="form-control" required/>
           </div>
           <div class="form-group">
             <button id="signupSubmit" type="submit" class="btn btn-info btn-block">Masuk</button>
           </div>           
           <p>Belum punya akun? Silahkan <a href="<?=base_url()?>register">Daftar</a></p>
         </form>
        </div>
      </div>
    </div>
